    ...
    def _fetch_sports_universe(self) -> Tuple[List[Dict[str, Any]], Dict[str, str], int, Dict[str, Dict[str, int]]]:
        ...
        for tag_id, tag_source in tag_sources.items():
            ...
            logging.info(
                ...
                tag_source,
                len(tag_events),
                len(filtered_tag_events),
                source_counts[tag_source].get("source_mismatch", 0),
            )
...
def load_config() -> Config:
    ...
    return Config(
        ...
        log_accepted_markets=env_bool("LOG_ACCEPTED_MARKETS", True),
        ...
        log_rejected_markets_sample=max(0, env_int("LOG_REJECTED_MARKETS_SAMPLE", 20)),
